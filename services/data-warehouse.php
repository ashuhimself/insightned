...
<?php echo getMetaTags('data-warehouse', 'data-warehouse'); ?>
            ...
            <div class="service-features">
                ...
                <div class="features-grid">
                    <div class="feature-card">
                        ...
                        <h3>Schema Design</h3>
                        <p>Optimize data structure for efficient querying and analysis.</p>
                    </div>
                    <div class="feature-card">
                        <i class="fas fa-project-diagram"></i>
                        <h3>Data Modeling</h3>
                        <p>Create comprehensive data models for your business needs.</p>
                    </div>
                    <div class="feature-card">
                        <i class="fas fa-tachometer-alt"></i>
                        <h3>Performance Tuning</h3>
                        <p>Optimize warehouse performance for faster data access.</p>
                    </div>
                    <div class="feature-card">
                        <i class="fas fa-shield-alt"></i>
                        <h3>Data Governance</h3>
                        <p>Implement robust data management and security practices.</p>
                    </div>
                </div>
            </div>
