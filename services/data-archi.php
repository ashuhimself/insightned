...
<?php echo getMetaTags('data-archi', 'data-archi'); ?>
...
<body>
    ...
    <nav class="main-nav">
        <div class="container">
            ...
            <div class="nav-links">
                ...
                <a href="../contact.html" class="cta-button" target="_blank">Get Started</a>
            </div>
        </div>
    </nav>
    ...
    <div class="service-hero">
        <div class="container">
            <h1>Data Architecture and Strategy</h1>
            ...
            <div class="service-features">
                ...
                <div class="features-grid">
                    <div class="feature-card">
                        ...
                        <p>Our expertise in data architecture revolves around designing robust and scalable EDW/Data Lake that facilitate efficient data management and utilization.</p>
                    </div>
                    <div class="feature-card">
                        <div class="feature-icon">
                            <i class="fas fa-layer-group"></i>
                        </div>
                        <h3>Build Modern Data Platforms</h3>
                        <p>We create modern data platforms that harness the power of cloud computing with technologies enabling rapid Business Insights.</p>
                    </div>
                    <div class="feature-card">
                        <div class="feature-icon">
                            <i class="fas fa-chart-line"></i>
                        </div>
                        <h3>Data and Analytics Strategy</h3>
                        <p>Assess, Design data, and analytcis strategy and blueprint with recommendations roadmap.</p>
                    </div>
                    <div class="feature-card">
                        <div class="feature-icon">
                            <i class="fas fa-cloud-upload-alt"></i>
                        </div>
                        <h3>Data Platform Migration Strategy to Cloud</h3>
                        <p>Design and recommend a strategy to migrate on-premise legacy data platforms to modern data platforms on the cloud.</p>
                    </div>
                </div>
