...
<?php echo getMetaTags('business-analytics', 'business-analytics'); ?>
            ...
            <div class="service-features">
                ...
                <div class="features-grid">
                    <div class="feature-card">
                        ...
                        <p>Gain deep insights into market trends and competitive landscape.</p>
                    </div>
                    <div class="feature-card">
                        <i class="fas fa-users"></i>
                        <h3>Customer Insights</h3>
                        <p>Understand customer behavior and preferences through data analysis.</p>
                    </div>
                    <div class="feature-card">
                        <i class="fas fa-dollar-sign"></i>
                        <h3>Revenue Optimization</h3>
                        <p>Identify opportunities to maximize revenue and reduce costs.</p>
                    </div>
                    <div class="feature-card">
                        <i class="fas fa-rocket"></i>
                        <h3>Growth Strategy</h3>
                        <p>Develop data-driven strategies for sustainable business growth.</p>
                    </div>
                </div>
