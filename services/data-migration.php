...
<?php echo getMetaTags('data-migration', 'data-migration'); ?>
            ...
            <div class="service-features">
                ...
                <div class="features-grid">
                    <div class="feature-card">
                        ...
                        <p>Modernize your infrastructure by migrating from legacy systems.</p>
                    </div>
                    <div class="feature-card">
                        <i class="fas fa-cloud-upload-alt"></i>
                        <h3>Cloud Migration</h3>
                        <p>Seamlessly transition your data and applications to the cloud.</p>
                    </div>
                    <div class="feature-card">
                        <i class="fas fa-check-double"></i>
                        <h3>Data Validation</h3>
                        <p>Ensure data accuracy and integrity throughout migration.</p>
                    </div>
                    <div class="feature-card">
                        <i class="fas fa-shield-alt"></i>
                        <h3>Risk Management</h3>
                        <p>Minimize downtime and mitigate risks during migration.</p>
                    </div>
                </div>
