...
<?php echo getMetaTags('ad-platforms', 'ad-platforms'); ?>
...
<body>
    ...
    <div class="service-hero">
        <div class="container">
            <h1>Ad Platforms Integration</h1>
            ...
            <div class="service-features">
                ...
                <div class="features-grid">
                    <div class="feature-card">
                        ...
                        <p>Optimize your Google Ads campaigns with data-driven insights.</p>
                    </div>
                    <div class="feature-card">
                        <i class="fab fa-facebook"></i>
                        <h3>Meta Ads Setup</h3>
                        <p>Maximize your social media advertising performance.</p>
                    </div>
                    <div class="feature-card">
                        <i class="fas fa-chart-bar"></i>
                        <h3>Cross-Platform Analytics</h3>
                        <p>Unified analytics across all your advertising channels.</p>
                    </div>
                    <div class="feature-card">
                        <i class="fas fa-bullseye"></i>
                        <h3>Performance Optimization</h3>
                        <p>Continuous optimization for better advertising results.</p>
                    </div>
                </div>
